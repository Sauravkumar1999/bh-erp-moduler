...
class TranslationLanguageController extends Controller
{
    ...
    public function index(TranslationLanguageDataTable $dataTable)
    {
        $breadcrumbs = [
            ...
            ['name' => trans('translation::translation.translation-languages'), 'url' => '#']
        ];
        $title = trans('translation::translation.translation-languages');

        return $dataTable->render('translation::translation-languages.index', compact('breadcrumbs', 'title'));
    }
