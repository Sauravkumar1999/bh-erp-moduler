...
@section('title', __('allowance::allowance.create'))
@section('content_header')
    <div class="d-flex align-content-center">
        ...
        <x-core-content-header :title="__('allowance::allowance.create')" :breadcrumbs="$breadcrumbs" />
    </div>
@stop
@section('css')
...
@section('content')
    ...
    <x-adminlte-card theme="primary" header-class="d-none" body-class="mt-4" theme-mode="outline">
        ...
        <form autocomplete="off" method="POST" action="{{ route('admin.allowances.store') }}">
            @csrf
            <div class="form-group mb-4 readonly">
                <label for="payment_month" class="form-label">{{ __('allowance::allowance.payment-month') }}</label>
                <input id="payment_month" name="payment_month" value="{{ old('payment_month') }}"
            ...
            <div class="form-group mb-4">
                ...
                <select class="form-select memberSelect  @error('member_id') is-invalid @enderror" id="member_id"
                    ...
                    <option value="" selected>{{ __('allowance::allowance.member-selection') }}</option>
            ...
            <div class="form-group mb-4 readonly">
                ...
                <input id="code" name="" value="" class="form-control"
            ...
            <div class="form-group mb-4 readonly">
                ...
                <input id="birth_date" name="" value="" class="form-control"
            ...
            <div class="form-group mb-4 readonly">
                ...
                <input id="rank" name="" value="" class="form-control"
                    placeholder="{{ __('allowance::allowance.rank') }}" readonly="readonly">
            </div>

            <div class="form-group mb-4">
                <label for="commission" class="form-label">{{ __('allowance::allowance.commission') }}</label>
                <input id="commission" name="commission" value="" class="form-control deducted_amount inputmask" placeholder="{{ __('allowance::allowance.commission') }}">
            </div>

            <div class="form-group mb-4">
                <label for="referral_bonus" class="form-label">{{ __('allowance::allowance.referral-bonus') }}</label>
                <input id="referral_bonus" name="referral_bonus" value="" class="form-control deducted_amount inputmask" placeholder="{{ __('allowance::allowance.referral-bonus') }}">
            </div>
            ...
            <div class="form-group mb-4">
                ...
                <input id="headquarters_representative_allowance" type="text"
                    name="headquarters_representative_allowance" value="{{ old('headquarters_representative_allowance') }}"
            ...
            <div class="form-group mb-4">
                ...
                <input id="organization_division_allowance" type="text" name="organization_division_allowance"
                    value="{{ old('organization_division_allowance') }}"
            ...
            <div class="form-group mb-4">
                ...
                <input id="policy_allowance" type="text" name="policy_allowance" value="{{ old('policy_allowance') }}"
            ...
            <div class="form-group mb-4">
                <label for="other_allowances"
                    class="form-label">{{ __('allowance::allowance.other-allowances') }}</label>
            ...
            <div class="form-group mb-4">
                ...
                <input id="income_tax" type="text" name="income_tax" value="{{ old('income_tax') }}"
            ...
            <div class="form-group mb-4">
                ...
                <input id="resident_tax" type="text" name="resident_tax" value="{{ old('resident_tax') }}"
            ...
            <div class="form-group mb-4 readonly">
                ...
                <input id="total_deduction" name="total_deduction" value="" class="form-control inputmask"
            ...
            <div class="form-group mb-4 readonly">
                ...
                <input id="total_before_tax" name="total_before_tax" value="" class="form-control inputmask"
                    placeholder="{{ __('allowance::allowance.total-deduction') }}" readonly>
            </div>
            <div class="form-group mb-5 readonly">
                ...
                <input id="deducted_amount_received" name="deducted_amount_received" value=""
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.deducted_amount').on('keyup', function() {
                ...
                $('#deducted_amount_received').val(totalSum);
            });
