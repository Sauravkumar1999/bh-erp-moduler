...
@endpush
@section('title', __('allowance::allowance.allowance-details'))
@section('content')
    <div class="anoucement-main">
        <div class="anoucement">
            <div class="anoucement-header">
                <div class="header d-flex justify-content-between align-items-center">
                    <div class="header-title text-nowrap">{{ trans('allowance::allowance.allowance-details') }}</div>
                    <div class="header-button-main cursor-pointer">
                        <div>
                            <a href="{{ route('admin.allowance-payments.index') }}"
                            ...
                            <div class="info-container">
                                ...
                                <div class="author-date-container">
                                    ...
                                    <div class="author">{{ trans('bulletin::msg.author') }} :
                                        {{ $post->writer ? $post->writer->first_name . ' ' . $post->writer->last_name : 'N/A' }}
                                    </div>
                    ...
                    <div class="content-container">
                        ...
                        <div class="navigation-container">
                            @if (!is_null($previousPost))
                                <a class="prev-post"
                                    href="{{ route('admin.allowance-payments.show', $previousPost->id) }}">
                                    <div class="label">{{ trans('bulletin::msg.previous') }}</div>
                                    <div class="text">{{ $previousPost->title }}</div>
                                </a>
                            @endif
                            @if (!is_null($nextPost))
                                <a class="next-post" href="{{ route('admin.allowance-payments.show', $nextPost->id) }}">
