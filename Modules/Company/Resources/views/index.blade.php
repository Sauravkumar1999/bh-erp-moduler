...
@section('title', __('company::company.company'))

@section('content_header')

    <x-core-content-header :title="__('company::company.company')" :breadcrumbs="$breadcrumbs" />
                ...
                <div class="modal-body">
                    <div class="table_div">
                        <table border="1" class="company-table">
                            <tr>
                                <td class="titles">@lang('company::company.business-name')</td>
                                <td id="business_name"></td>
                            </tr>

                            <tr>
                                <td class="titles">@lang('company::company.license-number')</td>
                                <td id="license_number"></td>
                            </tr>
                            <tr>

                                <td class="titles">@lang('company::company.address')</td>
                                <td id="address"></td>
                            </tr>
