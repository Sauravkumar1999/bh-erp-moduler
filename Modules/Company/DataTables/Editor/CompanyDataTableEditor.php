...
namespace Modules\Company\DataTables\Editor;
...
class CompanyDataTableEditor extends DataTablesEditor
{
    use MediaHandler, ManageCompanySquence;
    ...
    {
        $data['code'] = $this->getCompanyNextCode();
    ...
    public function upload(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        try {
            if ($field === 'contract') {
                $media = $this->uploadContract($file);
            } else {
                $media = $this->uploadCompanyImage($file);
            }
