                                    ...
                                    @foreach ($perm_names as $name)
                                        <div class="mb-3 row">
                                            ...
                                            <div class="checkbox col-3">
                                                ...
                                                <input id="select_all_{{ $name }}" type="checkbox" autocomplete="off" value="{{ boolval(true) }}" wire:model="permission_containers.{{ $name }}" class="form-check-input" onchange="selectPermissions(this, '{{ $name }}')"> Select All</label>
                                            </div>
