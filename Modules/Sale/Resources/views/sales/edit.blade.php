...
@section('content')
    ...
    <x-adminlte-card theme="primary" theme-mode="outline">
        <form autocomplete="off" method="POST" action="{{ route('admin.sales.update', $sale) }}">
            @method('PUT')
            @csrf
            <div class="form-group mb-4 ">
                ...
                <input id="product_sale_day" type="text" name="product_sale_day"
                    value="{{ old('product_sale_day', $sale->product_sale_day ?? 'N/A') }}"
            ...
            <div class="form-group mb-4 ">
                ...
                <input id="company_id" type="text" name="company_id"
                    value="{{ old('company_id', $sale->product->company->name ?? 'N/A') }}"
            ...
            <div class="form-group mb-4 ">
                ...
                <input id="product_code" type="text" name="product_code"
                    value="{{ old('product_code', $sale->product->code ?? 'N/A') }}"
            ...
            <div class="form-group mb-4 ">
                ...
                <input id="fee_type" type="text" name="fee_type"
                    value="{{ old('fee_type', trans('sale::sale.' . $sale->fee_type) ?? 'N/A') }}"
            ...
            <div class="form-group mb-4 ">
                ...
                <input id="product_price" type="text" name="product_price"
                    value="{{ old('product_price', $sale->product->product_price ?? 'N/A') }}"
            ...
            <div class="form-group mb-4 ">
                ...
                <textarea id="remark" name="remark" value="{{ old('remark') ?? $sale->remark }}" class="form-control"
                    placeholder="{{ trans('sale::sale.enter-remark') }}">{{ old('remark', $sale->remark ?? 'N/A') }}</textarea>
            </div>
            ...
            <div class="mt-2">
                <div class="form-group mb-4 ">
                    <label for="sales_price">{{ trans('sale::sale.sale-price') }}</label>
                    <input id="sales_price" type="text" name="sales_price"
                        value="{{ old('sales_price', $sale->sales_price) }}"
            ...
            <div class="form-group mb-4 ">
                ...
                <input id="number_of_sales" type="text" name="number_of_sales"
                    value="{{ old('number_of_sales', $sale->number_of_sales ?? 'N/A') }}"
            ...
            <div class="form-group mb-4 ">
                ...
                <input id="take" type="text" name="take" value="{{ old('take', $sale->take ?? 'N/A') }}"
            ...
            <div class="form-group mb-4 ">
                ...
                <textarea id="sales_information" name="sales_information"
                    value="{{ old('sales_information', $sale->sales_information) }}"
                    class="form-control @error('sales_information') is-invalid @enderror"
                    placeholder="{{ trans('sale::sale.enter-sales-information') }}">{{ old('sales_information', $sale->sales_information ?? 'N/A') }}</textarea>
            ...
            <!--div class="form-group mb-4 ">
                                                    ...
                                                    <input id="bh_operating_income" type="text" name="bh_operating_income"
                                                        value="{{ isset($sale->product->bh_sale_commissions) ? $sale->product->bh_sale_commissions : 'N/A' }}"
    ...
    @enderror
                    ...
                    <div class="col-9">
                        <div class="form-group mb-4 ">
                            <input id="branch_representative" type="text" name="branch_representative"
                                value="{{ isset($sale->product->product_commissions['normal']['commission_bp']) ? $sale->product->product_commissions['normal']['commission_bp'] : 'N/A' }}"
                    ...
                    <div class="col-10">
                        <div class="form-group mb-4 ">
                            <input id="branch_agent" type="text" name="branch_agent"
                                value="{{ isset($sale->product->product_commissions['normal']['commission_ba']) ? $sale->product->product_commissions['normal']['commission_ba'] : 'N/A' }}"
                    ...
                    <div class="col-10">
                        <div class="form-group mb-4 ">
                            <input id="managing_director" type="text" name="managing_director_normal"
                                value="{{ isset($sale->product->product_commissions['normal']['commission_md']) ? $sale->product->product_commissions['normal']['commission_md'] : 'N/A' }}"
                    ...
                    <div class="col-10">
                        <div class="form-group mb-4 ">
                            <input id="principal_managing_director" type="text"
                                ...
                                value="{{ isset($sale->product->product_commissions['normal']['commission_pmd']) ? $sale->product->product_commissions['normal']['commission_pmd'] : 'N/A' }}"
                    ...
                    <div class="col-md-10">
                        <div class="form-group mb-4 ">
                            <input id="md" type="text" name="managing_director_head"
                                value="{{ isset($sale->product->product_commissions['headquarter']['md']) ? $sale->product->product_commissions['headquarter']['md'] : 'N/A' }}"
                    ...
                    <div class="col-10">
                        <div class="form-group mb-4 ">
                            <input id="pmd" type="text" name="principal_managing_director_head"
                                value="{{ isset($sale->product->product_commissions['headquarter']['pmd']) ? $sale->product->product_commissions['headquarter']['pmd'] : 'N/A' }}"
            ...
            <div class="form-group mb-4 ">
                ...
                <input id="referral_bonus" type="text" name="referral_bonus"
                    value="{{ old('referral_bonus', $sale->product->referral_bonus ?? 'N/A') }}"
            ...
            @php
                ...
                $refUser = get_referral_user($sale->user_id);
            ...
            <div class="form-group mb-4 ">
                ...
                <input id="other_fees" type="text" name="other_fees"
                    value="{{ isset($sale->product->other_fees) ? $sale->product->other_fees : 'N/A' }} "
            ...
            <div class="form-group mb-4 ">
                ...
                <textarea id="other_fees_reasons" name="other_fees_reasons"
                    value="{{ old('other_fees_reasons', $sale->sale_status ?? 'N/A') }} "
                    class="form-control @error('other_fees_reasons') is-invalid @enderror"
                    placeholder="{{ trans('sale::sale.other-fees-content') }}">{{ isset($sale->sale_status) ? $sale->sale_status : 'N/A' }}</textarea>
            ...
            <!--div class="form-group mb-4 ">
                                                    ...
                                                    <input id="operating_income" type="text" name="operating_income"
                                                        value="{{ old('operating_income', $sale->operating_income ?? 'N/A') }}"
    ...
    @enderror
            ...
            <div class="mt-2">
                ...
                <div class="my-2">
                    <input class="form-check-input sales_rights_check" type="radio" name="sales_status"
                        id="status_proceeding" {{ $sale->salesApproval ? '' : 'disabled' }} value="proceeding"
                        {{ old('sales_status', $sale->sales_status) == 'proceeding' || !old('sales_status') ? 'checked' : '' }}>
                    <label class="form-check-label" for="status_proceeding">{{ trans('sale::sale.proceeding') }}</label>
                    <input class="form-check-input sales_rights_check" type="radio" name="sales_status"
                        id="status_confirmed" {{ $sale->salesApproval ? '' : 'disabled' }} value="confirmed"
                        {{ old('sales_status', $sale->sales_status) == 'confirmed' ? 'checked' : '' }}>
                    <label class="form-check-label" for="status_confirmed">{{ trans('sale::sale.confirmed') }}</label>
                    <input class="form-check-input sales_rights_check" type="radio" name="sales_status"
                        id="status_cancellation" {{ $sale->salesApproval ? '' : 'disabled' }} value="cancellation"
                        {{ old('sales_status', $sale->sales_status) == 'cancellation' ? 'checked' : '' }}>
                    <label class="form-check-label"
                        for="status_cancellation">{{ trans('sale::sale.cancellation') }}</label>
                    <input class="form-check-input sales_rights_check" type="radio" name="sales_status"
                        id="status_refund" {{ $sale->salesApproval ? '' : 'disabled' }} value="refund"
                        {{ old('sales_status', $sale->sales_status) == 'refund' ? 'checked' : '' }}>
            ...
            @php($sale_user = $sale->user)

            <div class="form-group mt-3">
                <div class="form-group mb-4 ">
                    <label for="current_user">{{ trans('sale::sale.created-by') }}</label>
                    <input id="current_user" type="text" name="current_user"
                        value="{{ $sale_user->full_name . '(' . $sale_user->code . ')' }}"
                        class="form-control read-only readonly @error('current_user') is-invalid @enderror" readonly>
                    @error('current_user')
                        <div class="invalid-feedback">{{ trans('sale::sale.current-user-required') }}</div>
                    @enderror
                </div>
...
@section('js')
    ...
    <script>
        let commissions_charge_array = [
            "{{ $sale->product->bh_sale_commissions }}",
            "{{ $sale->product->product_commissions['normal']['commission_bp'] }}",
            "{{ $sale->product->product_commissions['normal']['commission_ba'] }}",
            "{{ $sale->product->product_commissions['normal']['commission_md'] }}",
            "{{ $sale->product->product_commissions['normal']['commission_pmd'] }}",
            "{{ $sale->product->product_commissions['headquarter']['md'] }}",
            "{{ $sale->product->product_commissions['headquarter']['pmd'] }}",
            "{{ $sale->product->referral_bonus }}",
        ];
        var commission_type = "{{ $sale->fee_type }}";
            ...
            $('#product_id').change(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        let salesApproval = response?.salesApproval;
                        if (salesApproval) {
                            $('.sales_rights_check').prop('disabled', false)
                        } else {
                            $('.sales_rights_check').prop('disabled', true)

                        }
                        $('#company_id').val((response.company) ? response.company.name :
                            'N/A');
                        $('#compnay_name').val((response.compnay_name) ? response.compnay_name :
                            'N/A');
                        $('#product_code').val((response.code) ? response.code : 'N/A');
                        $('#fee_type').val((response.commission_type) ? response
                            .commission_type : 'N/A');
                        $('#product_price').val((response.product_price) ? response
                            .product_price : 'N/A');
                        $('#product_sale_status').val((response.sale_status) ? response
                            .sale_status : 'N/A');
                        $('#product_name').val((response.product_name) ? response.product_name :
                            'N/A');
                        $('#sales_status').val((response.sales_status) ? response.sales_status :
                            'N/A');
                        ...
                        $('#branch_agent').val((response.product_commissions) ? response
                            .product_commissions.normal.commission_ba : 'N/A');
                        $('#managing_director').val((response.product_commissions) ? response
                            .product_commissions.normal.commission_md : 'N/A');
                        $('#principal_managing_director').val((response.product_commissions) ?
                            response.product_commissions.normal.commission_pmd : 'N/A');
                        $('#md').val((response.product_commissions) ? response
                            .product_commissions.headquarter.md : 'N/A');
                        $('#pmd').val((response.product_commissions) ? response
                            .product_commissions.headquarter.pmd : 'N/A');

                        $('#referral_bonus').val((response.referral_bonus) ? response
                            .referral_bonus : 'N/A');
