...
use Modules\Product\Rules\NumberFormatRule;
...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "product_price"         => [new RequiredIf($this->commission_type == 'fixed-price')],
            ...
            "company_id"            => [
                // If sale_rights is not 'full_disclosure', make company_id required
                $this->sale_rights != 'full_disclosure' ? 'required' : 'nullable',
                'array',
            ],
