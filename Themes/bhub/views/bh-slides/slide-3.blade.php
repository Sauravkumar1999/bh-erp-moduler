...
<body class="slider-body" style="background-color: rgba(175, 207, 37, 0.1)">
    ...
    <div class="card">
        <div class="card-content-texts3">
            <h6>지사대표 등록 및 추천인 윈윈 이벤트</h6>
            <h5>신규 지사대표 등록 : P2U 10만</h5>
            <h5>신규 지사대표 추천인 : P2U 10만</h5>
            <h7>*기간 : 2024.05.01~별도공지일까지</h7>
        </div>
        <div class="card-img3">
            <img src="{{ themes('images/p2u.png') }}" alt="p2u-logo">
        </div>
    </div>
    <script>
