    ...
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-4">
      ...
      <div class="navbar-brand app-brand demo d-flex py-0 py-lg-2 me-4">
        ...
        {{-- <a href="{{url('front-pages/landing')}}" class="app-brand-link"> --}}
          ...
          <span class="app-brand-logo demo"><img src="{{url('images/erp_logo.png')}}"></span>
              ...
              <div class="row gy-4">
                ...
                <div class="col-lg-4 d-none d-lg-block">
                  <div class="bg-body nav-img-col p-2">
                    <img src="{{asset('vendor/vuexy/img/front-pages/misc/nav-item-col-img.png')}}" alt="nav item col image" class="w-100">
                  </div>
                </div>
              </div>
            </div>
