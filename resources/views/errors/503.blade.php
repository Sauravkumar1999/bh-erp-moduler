<!DOCTYPE html>
<html lang="en" class="light-style layout-wide  customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('vendor/vuexy')}}/" data-template="vertical-menu-template">
...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('vendor/vuexy')}}/vendor/css/rtl/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('vendor/vuexy')}}/vendor/css/rtl/theme-default.css" class="template-customizer-theme-css" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
<link rel="stylesheet" href="{{ asset('vendor/vuexy')}}/vendor/css/pages/page-misc.css">
...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    <h2 class="mb-1 mx-2">비즈니스 허브 리뉴얼 작업으로 인해 시스템 접속이 잠시 중단됩니다.!</h2>
    <p class="mb-4 mx-2">
      Sorry for the inconvenience but we're performing some maintenance at the moment
    </p>
    <div class="mt-4">
      <img src="{{ asset('vendor/vuexy')}}/img/illustrations/page-misc-under-maintenance.png" alt="page-misc-under-maintenance" width="550" class="img-fluid">
    </div>
  </div>
</div>
<div class="container-fluid misc-bg-wrapper misc-under-maintenance-bg-wrapper">
  <img src="{{ asset('vendor/vuexy')}}/img/illustrations/bg-shape-image-light.png" alt="page-misc-under-maintenance" data-app-light-img="illustrations/bg-shape-image-light.png" data-app-dark-img="illustrations/bg-shape-image-dark.html">
</div>
